...
abstract class CFloor6Listener extends ParseTreeListener {
  ...
  /// Enter a parse tree produced by [CFloor6Parser.expression].
  /// [ctx] the parse tree
  void enterExpression(ExpressionContext ctx);
  /// Exit a parse tree produced by [CFloor6Parser.expression].
  /// [ctx] the parse tree
  ...
  /// Enter a parse tree produced by [CFloor6Parser.arrayAccessExpression].
  /// [ctx] the parse tree
  void enterArrayAccessExpression(ArrayAccessExpressionContext ctx);
  /// Exit a parse tree produced by [CFloor6Parser.arrayAccessExpression].
  /// [ctx] the parse tree
